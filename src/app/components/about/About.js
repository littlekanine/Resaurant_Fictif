...
const About = () => {
	return (
		<div>
			<section className="flex items-center justify-center flex-row bg-sombre p-8">
				<div className="flex flex-col items-center justify-center h-full w-full text-center gap-4 p-20">
					<div className="flex flex-col h-full w-lg gap-4">
						<h3 className="flex font-inter text-gold text-3xl text-left w-full ">Notre histoire</h3>
						<p className="text-white font-inter text-left text-lg">
						...
						<div className="flex flex-row w-full items-center rounded-full gap-4">
							...
							<p className="text-gold font-inter text-lg">Chef Michel Laurent</p>
						</div>
					</div>
				</div>
				<div className="grid grid-cols-2 gap-4 w-full h-auto p-4">
